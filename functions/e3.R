e3<-function(raw_datasets, dprior){ # 3-RHYMEWORD
  ...
  # RHYMEWORD (2016-21): Can this child rhyme words?
      # value label
      # 1   Yes
      # 2    No
  ...
  syntax_e3 = list(
    ...
    VARIABLE = list(USEV = c("e3_1621", "e3_22"), 
                    CATEGORICAL = c("e3_1621", "e3_22")
    ),
    MODEL= c("!e3: RHYMEWORD (2016-2021; _1) & RHYMEWORD_R (2022; _2)",
             "   EL by e3_1621*1 (le3_1) e3*1 (le3_2)",
             "   [e3_1621$1*] (t1e3_1)  [e3$1*] (t1e3_2)", 
             "                          [e3$2*] (t2e3_2)", 
             "                          [e3$3*] (t3e3_2)",
             "                          [e3$4*] (t4e3_2)"
    ),
  ...
  plot_e3 = weighted_twoway(df = df_e3, var = "e3_1621") %>% 
    bind_rows(weighted_twoway(df_e3, var = "e3_22")) %>% 
    dplyr::arrange(sc_age_years) %>% 
    tau_plot(item="e3_22", what = "cumulative", syntax=syntax_e3)
